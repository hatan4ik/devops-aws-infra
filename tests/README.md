...
| AuthN/AuthZ and failover journey | [`post_deploy/auth-api-synthetic-contract.md`](post_deploy/auth-api-synthetic-contract.md) | Staging before production and every material identity, authorization, routing, or regional change | Uses an approved isolated synthetic identity; no production user data or secrets in output. |
