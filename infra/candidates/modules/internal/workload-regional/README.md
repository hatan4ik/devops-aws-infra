...
| Name | Source | Version |
| ---- | ------ | ------- |
| <a name="module_cognito_primary"></a> [cognito\_primary](#module\_cognito\_primary) | git::https://github.com/hatan4ik/aws.modules.cognito.git | v0.1.1 |
| <a name="module_vpc"></a> [vpc](#module\_vpc) | git::https://github.com/hatan4ik/aws.modules.vpc.git//modules/workload | v0.1.1 |
