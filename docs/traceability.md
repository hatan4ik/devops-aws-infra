...
| Two-Region availability and data | [ADR 0002](adr/0002-regional-availability-and-data.md), [assumptions A-01–A-07](ASSUMPTIONS.md) | [Regional roots](../terraform/roots/) | Terraform validation and module tests | Approved Regions, quotas, capacity/load and failover game-day evidence | Designed; prerequisites open. |
| Segmented networking and hybrid connectivity | [ADR 0003](adr/0003-segmented-tgw-ipam-and-encryption.md), [ADR 0005](adr/0005-hybrid-connectivity.md) | [TGW hub](../terraform/modules/terraform-aws-tgw-hub/), [network composition](../terraform/modules/internal/network-regional/) | Module `terraform test` and read-only network verifier | CIDR/ASN approval, route-table, BGP tunnel and segmentation evidence | Designed; external inputs required. |
...
| Million-user authentication and authorization | [ADR 0006](adr/0006-identity-and-authorization.md), [ADR 0011](adr/0011-cognito-mrr-provider-boundary.md) | [Cognito module](../terraform/modules/terraform-aws-cognito-userpool/) | Cognito module tests and AuthN/AuthZ synthetic contract | Quota approval, load test, provider-managed MRR lifecycle, and product auth results | Designed; MRR and capacity are blocked pending validation. |
| AWS-native compute and data plane | [ADR 0007](adr/0007-compute-and-data.md) | [Workload composition](../terraform/modules/internal/workload-regional/) | Terraform validation and module tests | Application contract, capacity benchmark, data-model/restore evidence | Designed; not an AWS deployment. |
| Security and isolated state | [ADR 0008](adr/0008-security-and-state.md), [ADR 0015](adr/0015-adopt-legacy-state-bootstrap.md), [ADR 0016](adr/0016-terraform-state-lock-transition.md) | [State backend](../terraform/modules/internal/state-backend/), [adoption root](../terraform/roots/foundation/region-a/bootstrap-state/) | Terraform tests; [ADR boundary check](../scripts/verify-adr-boundary.sh) | Specialist quorum, protected state backup, no-change plan/apply, refresh-only plan, restore drill, and cost baseline | Source ready for review; remote state remains gated. |
...
authoritative decision set. The root-level `modules/` and `roots/` directories
are disabled historical prototypes and are deliberately excluded from this
matrix.
