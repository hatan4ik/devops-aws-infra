...
| Private ECS Fargate services | [aws.modules.ecs-service](https://github.com/hatan4ik/aws.modules.ecs-service) | `v0.1.3` | Active sandbox-workload root; task egress is ordered before service launch and permits only VPC-private endpoints plus the regional S3 prefix list required for ECR layers. |
