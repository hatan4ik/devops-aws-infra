...
| GitHub OIDC and delivery IAM | [aws.modules.iam](https://github.com/hatan4ik/aws.modules.iam) | `v0.1.9` | Active sandbox-delivery root, including opt-in ECR image publishers, scoped platform-state reads, and least-privilege autoscaling bootstrap/tag permissions. |
