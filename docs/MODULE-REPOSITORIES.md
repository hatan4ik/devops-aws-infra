...
| VPC foundations | [aws.modules.vpc](https://github.com/hatan4ik/aws.modules.vpc) | A v1 migration is prepared in draft; it must be pinned to the signed `v1.0.0` release before it can merge. |
