...
| Private ECS Fargate services | [aws.modules.ecs-service](https://github.com/hatan4ik/aws.modules.ecs-service) | `v0.1.0` | Active sandbox-workload root; it creates no service until a reviewed `applications` map is supplied. |
