...
| VPC foundations | [aws.modules.vpc](https://github.com/hatan4ik/aws.modules.vpc) | Active root uses `v0.3.0`; the v1 migration is prepared but cannot merge until `v1.0.0` is a signed release. |
