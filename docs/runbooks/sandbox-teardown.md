...
resource identity. It reads the full current Cognito configuration and retains
every field accepted by `UpdateUserPool` before changing only deletion protection;
